package xyz.lihang.blog.service.config;
...
public class ServiceConfig {
    ...
    private Logger logger = Logger.getLogger(ServiceConfig.class.getName());

    public static final int ARTICLE_ITEM_LENGTH = 10;
