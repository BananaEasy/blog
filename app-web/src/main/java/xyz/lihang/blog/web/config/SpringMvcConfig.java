package xyz.lihang.blog.web.config;
...
import xyz.lihang.blog.web.filter.HtmlFilter;
import xyz.lihang.blog.web.filter.ManagerFilter;
...
public class SpringMvcConfig extends WebMvcConfigurerAdapter {
    ...
    public static List<LoginUser> getUsers() {
        String text = JsonPares.readFileToString(userJsonPath);
        return JSONArray.parseArray(text,LoginUser.class);
    }
